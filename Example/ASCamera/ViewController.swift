...
class ViewController: CameraViewController {
    ...
    override func asCamera(_ asCamera: ASCamera, didSwitchCamera location: ASCameraLocation) {
...
extension ViewController {
    func addPermissionsView() {
        ...
        let title = "Welcome To ASCamera" + "\n\n"
        let subtitle = "Grant permission to Camera and Microphone to continue\n"
    ...
    fileprivate func presentGoToSettingsAlert() {
        let message = "ASCamera requires access to your camera and microphone, please change privacy settings."
