...
Pod::Spec.new do |s|
  s.name             = 'ASCamera'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ASCamera.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Angel/ASCamera'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Angel' => 'angel@angelengineering.com' }
  s.source           = { :git => 'https://github.com/Angel/ASCamera.git', :tag => s.version.to_s }
